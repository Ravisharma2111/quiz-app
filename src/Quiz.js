    ...
    >
      ...
      {showResults ? (
        ...
        <div>
          ...
          >
            (<Timer setStop={setStop} currentQuestion={currentQuestion} handletime={handletime} currData={currData} setCurrData={setCurrData}></Timer>)
          </h3>
